...
---@param self rdgs.CGameSetupManager
---@param skipDLCUpgradeCheck boolean
---@return boolean
function CGameSetupManager.InitStartGame(self, skipDLCUpgradeCheck ) end
---@param self rdgs.CGameSetupManager
---@return boolean
function CGameSetupManager.InitStartGame(self) end
---@param self rdgs.CGameSetupManager
