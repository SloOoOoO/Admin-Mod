---@meta rdgs.CConditionQuestDecimate
-- Generated File, do not edit (template Declaration.stg)

---@class rdgs.CConditionQuestDecimate
...
local CConditionQuestDecimate = {}
---@see CCondition parent class
---Satisfies this condition and all subconditions
---@param self rdgs.CConditionQuestDecimate
function CConditionQuestDecimate.SatisfyRecursiveNet(self) end
---@return boolean returns true if weak pointer holds a valid reference
function CConditionQuestDecimate.isValid() end
---@return boolean returns true if weak pointer holds a valid reference
function CConditionQuestDecimate.isValid() end

return CConditionQuestDecimate
