---@meta rdgs.CConditionQuestDestroy
-- Generated File, do not edit (template Declaration.stg)

---@class rdgs.CConditionQuestDestroy
...
local CConditionQuestDestroy = {}
---@see CCondition parent class
---Satisfies this condition and all subconditions
---@param self rdgs.CConditionQuestDestroy
function CConditionQuestDestroy.SatisfyRecursiveNet(self) end
---@return boolean returns true if weak pointer holds a valid reference
function CConditionQuestDestroy.isValid() end
---@return boolean returns true if weak pointer holds a valid reference
function CConditionQuestDestroy.isValid() end

return CConditionQuestDestroy
